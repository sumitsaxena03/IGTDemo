 ...
 * @see LoginPage
 */
public class ADTProductScreenTest {
	
	ADTProductScreen adtHomeScreen;

	
	
	protected ADTProductScreenTest() {	}	
	...
	@FrameworkAnnotations(author="Sumit", category="Regression", methodType="ADT Shop")
    public void AdtProductScreen() {
		ADTProductScreen adtProductScreen = new ADTProductScreen(DriverManager.getDriver());
		adtProductScreen.adtProductScreen();
	}
