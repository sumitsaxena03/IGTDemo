 ...
 * @see LoginPage
 */
public class ADTShopScreenTest {
	
	ADTShopScreen adtHomeScreen;

	
	
	protected ADTShopScreenTest() {	}	
	...
	@Test(description="ADT Shop", priority=1)
	@FrameworkAnnotations(author="Sumit", category="Regression", methodType="ADT Screen Test")
    public void AdtScreenShop() {
		ADTShopScreen adtShopScreen = new ADTShopScreen(DriverManager.getDriver());
		adtShopScreen.shopScreen();
	}
